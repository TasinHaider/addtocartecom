                    ...
                    <div className="grid items-start grid-cols-1 lg:grid-cols-5 gap-8 max-lg:gap-12 max-sm:gap-8">
                        ...
                        <div className="w-full lg:col-span-2">
                            ...
                            <div className="mt-6 flex flex-wrap gap-4">
                                <button
                                    type="button"
                                    className="px-4 py-3 w-[45%] cursor-pointer border border-gray-300 bg-gray-100 hover:bg-gray-200 text-slate-900 text-sm font-semibold"
                                >
                                    Add to wishlist
                                </button>
                                <button
                                    type="button"
                                    className="px-4 py-3 w-[45%] cursor-pointer border border-purple-600 bg-purple-600 hover:bg-purple-700 text-white text-sm font-semibold"
                                >
                                    Add to cart
                                </button>
                            </div>
